...
- General (work-in-progress) centralized app-instance available at top package-level. [#3475, #3526, #3522, #3531, #3555, #3577, #3675, #3684]
...
- Renamed ``Spectral Extraction`` plugin to ``Cube Spectral Extraction``. [#3691]
