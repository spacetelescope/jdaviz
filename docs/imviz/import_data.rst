...
.. code-block:: python
    ...
    imviz.plugins['Subsets']._obj.import_region("/path/to/data/myregions.reg")
...
.. code-block:: python
    ...
    bad_regions = imviz.plugins['Subsets']._obj.import_region("/path/to/data/myregions.reg", return_bad_regions=True)
