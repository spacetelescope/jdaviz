...
const tooltips = {
  ...
  'plugin-collapse-apply-overwrite': 'Collapse your data set and replace existing entry',
  ...
  'plugin-model-fitting-fit-overwrite': 'Fit the model to the data and replace the existing model',
  ...
  'plugin-moment-maps-calculate-overwrite': 'Calculate moment map and replace existing entry',
