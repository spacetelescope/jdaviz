...
class TableClickMessage(Message):
    ...
    def __init__(self, ra=None, dec=None, coord_unit="deg", slit_or_object = "object",
                 *args, **kwargs):
        super().__init__(*args, **kwargs)
        self._ra = ra
        self._dec = dec
        self._coord_unit = coord_unit
        self._slit_or_object = slit_or_object
    ...
    @property
    def slit_or_object(self):
        return self._slit_or_object
