...
__all__ = ['NewViewerMessage', 'ViewerAddedMessage', 'ViewerRemovedMessage', 'LoadDataMessage',
           ...
           'AddLineListMessage', 'RowLockMessage', 'TableClickMessage', 'WavClickMessage']
...
class WavClickMessage(Message):
    """Message generated by Specviz viewer when user double-click on spectrum
    to select wavelength that has been translated to slice index.
    """
    def __init__(self, selected_wavelength, slice_index, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self._wav = selected_wavelength
        self._islice = slice_index

    @property
    def selected_wavelength(self):
        return self._wav
