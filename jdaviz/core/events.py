...
__all__ = ['NewViewerMessage', 'ViewerAddedMessage', 'ViewerRemovedMessage', 'LoadDataMessage',
           ...
           'SliceWavelengthMessage', 'SliceToolActiveMessage',
           'TableClickMessage']
...
class SliceWavelengthMessage(Message):
    '''Message generated by the select slice plot plugin to request the helper to update
    across all viewers'''
...
class SliceToolActiveMessage(Message):
