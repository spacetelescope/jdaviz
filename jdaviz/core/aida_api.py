...
class AIDAMixin:
    ...
    def _set_center(self, center):
        ...
        imviz_aligned_by_wcs = self.jdaviz_app._align_by == 'wcs'
    ...
    def _get_current_center(self, sky_or_pixel, image_label=None):
        ...
        if self.jdaviz_app._align_by == 'wcs':
    ...
    def _get_current_projection(self):
        ...
        if not self.jdaviz_app._jdaviz_helper.plugins['Orientation'].align_by == 'WCS':
            return None
