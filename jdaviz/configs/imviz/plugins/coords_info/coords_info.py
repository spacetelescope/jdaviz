...
class CoordsInfo(TemplateMixin, DatasetSelectMixin):
    ...
    def _image_viewer_update(self, viewer, x, y):
        ...
        if coords_status:
            ...
            self._dict['world_ra'] = self._dict['world'][0]
            self._dict['world_dec'] = self._dict['world'][1]
        ...
        self._dict['pixel_x'] = self._dict['pixel'][0]
        self._dict['pixel_y'] = self._dict['pixel'][1]
