...
class BaseLinkHandler:
    ...
    def default_viewer_limits(self):
        return (self.imviz.default_viewer._obj.viewer.state.x_min,
                self.imviz.default_viewer._obj.viewer.state.x_max,
                self.imviz.default_viewer._obj.viewer.state.y_min,
                self.imviz.default_viewer._obj.viewer.state.y_max)
...
def test_imviz_no_data(imviz_helper):
    ...
    with pytest.raises(ValueError, match='No reference data for link look-up'):
        imviz_helper.default_viewer._obj.viewer.get_alignment_method('foo')
