...
class TestParseImage:
    ...
    def test_parse_hst_drz(self, imviz_helper):
        ...
        assert_quantity_allclose(tbl[0]['std'], 0.14436 * data_unit, rtol=1e-3)
        assert_quantity_allclose(tbl[0]['mad_std'], 0.0233 * data_unit, rtol=1e-3)
        ...
        assert_quantity_allclose(tbl[0]['fwhm'], 25.2262 * u.pix, rtol=1e-3)
        assert_quantity_allclose(tbl[0]['semimajor_sigma'], 12.958 * u.pix, rtol=1e-3)
        assert_quantity_allclose(tbl[0]['semiminor_sigma'], 7.849 * u.pix, rtol=1e-3)
        assert_quantity_allclose(tbl[0]['orientation'], 88.7336 * u.deg, rtol=1e-3)
        assert_quantity_allclose(tbl[0]['eccentricity'], 0.7957, rtol=1e-3)
