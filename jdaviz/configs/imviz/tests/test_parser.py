...
class TestParseImage:
    ...
    def test_parse_jwst_nircam_level2(self, imviz_helper):
        ...
        assert_allclose(phot_plugin.flux_scaling, 3.631e-3)
        ...
        assert_quantity_allclose(tbl[0]['aperture_sum_mag'], -12.804208824311152 * u.mag)
        assert_quantity_allclose(tbl[0]['flux_scaling'], 0.003631 * data_unit)
