...
def test_user_api(deconfigged_helper, image_2d_wcs, tmp_path):
    ...
    deconfigged_helper.load(ndd, data_label='data1')
    deconfigged_helper.load(ndd, data_label='data2')
...
def test_api_after_linking(deconfigged_helper):
    ...
    viewer = deconfigged_helper._app.get_viewer_by_id('imviz-0')
...
def test_footprint_updates_on_rotation(deconfigged_helper):
    ...
    marks = _get_markers_from_viewer(deconfigged_helper.default_viewer._obj.glue_viewer)
