...
class TestSimpleAperPhot(BaseImviz_WCS_WCS):
    def test_plugin_wcs_dithered(self):
        ...
        self.imviz.plugins['Subsets']._obj.import_region(reg)
        ...
        self.imviz.plugins['Subsets']._obj.combination_mode.selected = 'new'
        self.imviz.plugins['Subsets']._obj.import_region(reg)
...
class TestAdvancedAperPhot:
    ...
    def setup_class(self, imviz_helper):
        ...
        imviz_helper.plugins['Subsets']._obj.import_region([
...
def test_annulus_background(imviz_helper):
    ...
    imviz_helper.plugins['Subsets']._obj.import_region([circle_1, annulus_1],
                                                       combination_mode='new')
    ...
    imviz_helper.plugins['Subsets']._obj.import_region([ellipse_1, annulus_2],
                                                       combination_mode='new')
