...
SKIP_TEST_NODEIDS = [
    ...
    "test_orientation.py::TestDefaultOrientation::test_astrowidgets_markers_disable_relinking", # noqa
    "test_orientation.py::TestDefaultOrientation::test_markers_plugin_recompute_positions_pixels_to_wcs", # noqa
    "test_orientation.py::TestDefaultOrientation::test_markers_plugin_recompute_positions_wcs_to_pixels", # noqa
