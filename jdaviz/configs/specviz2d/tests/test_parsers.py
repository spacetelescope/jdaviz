...
def test_load_two_2d_spectra_deconfigged(deconfigged_helper):
    ...
    dc_2d_1 = deconfigged_helper._app.data_collection['2D Spectrum 1']
    dc_1d_1 = deconfigged_helper._app.data_collection['2D Spectrum 1 (auto-ext)']
    ...
    dc_2d_2 = deconfigged_helper._app.data_collection['2D Spectrum 2']
    dc_1d_2 = deconfigged_helper._app.data_collection['2D Spectrum 2 (auto-ext)']
...
def test_2d_parser_no_unit(deconfigged_helper, mos_spectrum2d):
    ...
    viewer_1d = deconfigged_helper._app.get_viewer('spectrum-viewer')
...
def test_2d_parser_hdulist_ext(tmp_path, deconfigged_helper, mos_spectrum2d_as_hdulist):
    ...
    deconfigged_helper.load(in_filename, ext=1, format='2D Spectrum')
    assert len(deconfigged_helper._app.data_collection) == 2
...
def test_2d_1d_parser(deconfigged_helper, mos_spectrum2d, spectrum1d):
    ...
    spec2d_viewer = deconfigged_helper._app.get_viewer('spectrum-2d-viewer')
    ...
    spec1d_viewer = deconfigged_helper._app.get_viewer('spectrum-viewer')
