...
def test_contour_unit_conversion(cubeviz_helper, spectrum1d_cube_fluxunit_jy_per_steradian):
    ...
    assert cubeviz_helper.viewers['flux-viewer']._obj.viewer.layers[0].state.attribute_display_unit == "Jy / sr"  # noqa
    ...
    assert cubeviz_helper.viewers['flux-viewer']._obj.viewer.layers[0].state.attribute_display_unit == "MJy / sr"  # noqa
...
def test_limits_on_unit_change(cubeviz_helper, start_unit, end_unit,
    ...
    new_limits = sv._obj.viewer.get_limits()
