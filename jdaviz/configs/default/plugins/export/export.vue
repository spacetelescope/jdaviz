<template>
  <j-tray-plugin
    ...
    <div v-if="viewer_items.length > 0">
      ...
      <j-flex-row v-if="viewer_invalid_msg.length> 0">
    ...
    <div v-if="dataset_items.length > 0 && serverside_enabled">
      ...
      <j-flex-row v-if="data_invalid_msg.length> 0">
        <span class="category-content v-messages v-messages__message text--secondary" style="color: red !important">
                  {{data_invalid_msg}}
        </span>
      </j-flex-row>
    ...
    <div v-if="subset_items.length > 0 && serverside_enabled">
      ...
      <j-flex-row v-if="subset_invalid_msg.length> 0">
        <span class="category-content v-messages v-messages__message text--secondary" style="color: red !important">
                  {{subset_invalid_msg}}
        </span>
      </j-flex-row>
      ...
      <j-flex-row v-if="subset_format_invalid_msg.length> 0">
        <span class="category-content v-messages v-messages__message text--secondary" style="color: red !important">
