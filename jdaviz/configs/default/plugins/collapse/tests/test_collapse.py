...
def test_linking_after_collapse(cubeviz_helper, spectral_cube_wcs):
    ...
    dc.external_links[0].cids1[0] == dc[0].pixel_component_ids[0]
    dc.external_links[0].cids2[0] == dc[1].pixel_component_ids[1]
    # Link 1:
    # Pixel Axis 1 [y] from cube.pixel_component_ids[1]
    # Pixel Axis 0 [y] from plugin.pixel_component_ids[0]
    dc.external_links[1].cids1[0] == dc[0].pixel_component_ids[1]
    dc.external_links[1].cids2[0] == dc[1].pixel_component_ids[0]
