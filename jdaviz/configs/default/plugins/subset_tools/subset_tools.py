...
from jdaviz.utils import MultiMaskSubsetState, chain_regions, data_has_valid_wcs
    ...
    * :meth:`rename_subset`
    ...
    def get_regions(self, region_type=None, list_of_subset_labels=None,
        ...
        subsets = self.app.get_subsets(spectral_only=region_type == ['spectral'],
                                       ...
                                       include_sky_region='sky' in reg_type,
            ...
            try:
                ...
                if isinstance(ss, SpectralRegion):
                    ...
                    if len(ss) == 1:
                        ...
                        regions[subset_label] = chain_regions([x[reg_type] for x in ss],
                                                              [x['glue_state'] for x in ss][1:])
