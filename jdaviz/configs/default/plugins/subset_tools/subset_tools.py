        ...
        * A masked Subset that will display on the image but cannot be
        ...
        with self._app._jdaviz_helper.batch_load():
            ...
            if edit_subset and combination_mode is not None:
                ...
                # self._app.session.edit_subset_mode.edit_subset = None
            ...
            for index, region in enumerate(regions):
                ...
                if (isinstance(region, (CircularAperture, EllipticalAperture,
                        ...
                        and (hasattr(self.app, '_link_type') and self._app._link_type == "wcs")):
                ...
                if (isinstance(region, (CirclePixelRegion, CircleSkyRegion,
                    ...
                    range_viewer = self._app.get_viewer(viewer_parameter) if viewer_parameter else self.spectrum_viewer  # noqa
                ...
                # Last resort: Masked Subset that is static (if data is not a cube)
                    ...
                    try:
                        ...
                        self._app.data_collection.new_subset_group(mask_label, state)
                        msg_count += 1
                    except Exception as e:  # pragma: no cover
                        bad_regions.append((region, f'Failed to load: {repr(e)}'))
                        continue
