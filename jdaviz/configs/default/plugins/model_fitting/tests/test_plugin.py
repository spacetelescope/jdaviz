...
def test_toggle_cube_fit_subset(cubeviz_helper):
    ...
    cubeviz_helper.plugins['Subsets'].import_region(SpectralRegion(7.5 * unit,
                                                                   8 * unit))
...
def test_reestimate_parameters(specviz_helper, spectrum1d):
    ...
    specviz_helper.plugins['Subsets'].import_region(SpectralRegion(7500 * unit,
                                                                   8000 * unit))
...
def test_subset_masks(cubeviz_helper, spectrum1d_cube_larger):
    ...
    cubeviz_helper.plugins['Subsets'].import_region(CircularROI(0.5, 0.5, 1))
