<template>
  ...
  >
    ...
    <v-app-bar v-if="!state.focus_viewer" color="toolbar" theme="dark" :density="state.settings.dense_toolbar ? 'compact' : 'default'" flat absolute :style="checkNotebookContext() ? 'margin-left: 1px; margin-right: 1px' : ''">
